...
# src/SoundCloud/Makefile.  Generated from Makefile.in by configure.
...
am__aclocal_m4_deps = $(top_srcdir)/build/m4/extensions/alarmclock.m4 \
	...
	$(top_srcdir)/build/m4/shamrock/libtool.m4 \
	$(top_srcdir)/build/m4/shamrock/ltoptions.m4 \
	$(top_srcdir)/build/m4/shamrock/ltsugar.m4 \
	$(top_srcdir)/build/m4/shamrock/ltversion.m4 \
	$(top_srcdir)/build/m4/shamrock/lt~obsolete.m4 \
...
BANSHEE_LIBS = -r:/usr/lib/banshee/Banshee.Widgets.dll -r:/usr/lib/banshee/Banshee.ThickClient.dll -r:/usr/lib/banshee/Banshee.Services.dll -r:Mono.Cairo -r:/usr/lib/banshee/Hyena.Gui.dll -r:/usr/lib/banshee/Banshee.Core.dll -r:System -r:/usr/lib/banshee/Mono.Media.dll -r:/usr/lib/cli/dbus-sharp-1.0/dbus-sharp.dll -r:/usr/lib/cli/dbus-sharp-glib-1.0/dbus-sharp-glib.dll -r:/usr/lib/pkgconfig/../../lib/cli/glib-sharp-2.0/glib-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/Mono.Addins-0.2/Mono.Addins.dll -r:Mono.Posix -r:/usr/lib/banshee/Hyena.dll -r:/usr/lib/banshee/Hyena.Data.Sqlite.dll -r:/usr/lib/banshee/MusicBrainz.dll -r:/usr/lib/pkgconfig/../../lib/cli/pango-sharp-2.0/pango-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/atk-sharp-2.0/atk-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/gdk-sharp-2.0/gdk-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/gtk-sharp-2.0/gtk-sharp.dll `pkg-config --libs taglib-sharp`  
...
BANSHEE_WEBBROWSER_LIBS = -r:/usr/lib/banshee/Banshee.WebBrowser.dll -r:/usr/lib/banshee/Banshee.Services.dll -r:Mono.Cairo -r:/usr/lib/banshee/Hyena.Gui.dll -r:/usr/lib/banshee/Banshee.Widgets.dll -r:/usr/lib/banshee/Banshee.ThickClient.dll -r:/usr/lib/banshee/Banshee.Core.dll -r:System -r:/usr/lib/banshee/Mono.Media.dll -r:/usr/lib/cli/dbus-sharp-1.0/dbus-sharp.dll -r:/usr/lib/cli/dbus-sharp-glib-1.0/dbus-sharp-glib.dll -r:/usr/lib/pkgconfig/../../lib/cli/glib-sharp-2.0/glib-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/Mono.Addins-0.2/Mono.Addins.dll -r:Mono.Posix -r:/usr/lib/banshee/Hyena.dll -r:/usr/lib/banshee/Hyena.Data.Sqlite.dll -r:/usr/lib/banshee/MusicBrainz.dll -r:/usr/lib/pkgconfig/../../lib/cli/pango-sharp-2.0/pango-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/atk-sharp-2.0/atk-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/gdk-sharp-2.0/gdk-sharp.dll -r:/usr/lib/pkgconfig/../../lib/cli/gtk-sharp-2.0/gtk-sharp.dll `pkg-config --libs taglib-sharp`  
BUILD_HOST_CPU = i686
BUILD_HOST_OS = linux-gnu
BUILD_TIME = 2012-10-31 14:32:59 EST
BUILD_VENDOR_ID = git-checkout
CATALOGS =  de.gmo el.gmo es.gmo fi.gmo fr.gmo it.gmo pt.gmo ru_RU.gmo sk.gmo uk_UA.gmo
CATOBJEXT = .gmo
CC = /bin/bash ../../build/m4/shave/shave cc gcc
...
CPP = gcc -E
CPPFLAGS = 
CXX = /bin/bash ../../build/m4/shave/shave cxx g++
CXXCPP = g++ -E
...
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DISTCHECK_CONFIGURE_FLAGS = --disable-scrollkeeper --enable-release
DLLTOOL = false
DMCS = /usr/bin/dmcs
DOC_USER_FORMATS = 
DSYMUTIL = 
...
F77 = /bin/bash ../../build/m4/shave/shave f77 
FC = /bin/bash ../../build/m4/shave/shave fc 
FFTW3F_CFLAGS = 
FFTW3F_LIBS = 
FGREP = /bin/grep -F
GCONFSHARP_CFLAGS =  
...
LIBSAMPLERATE_LIBS = 
LIBTOOL = /bin/bash ../../build/m4/shave/shave-libtool '$(SHELL) $(top_builddir)/libtool'
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
MAINT = 
...
MANIFEST_TOOL = :
MCS = /bin/bash ../../build/m4/shave/shave mcs /usr/bin/dmcs
MKDIR_P = /bin/mkdir -p
...
NUNIT_CONSOLE = 
NUNIT_LIBS = 
OBJC = /bin/bash ../../build/m4/shave/shave objc 
OBJDUMP = objdump
OBJEXT = o
OMF_DIR = ${datadir}/omf
OTOOL = 
...
PACKAGE_STRING = banshee-community-extensions 2.4.0
...
abs_builddir = ../../src/SoundCloud
abs_srcdir = ../../src/SoundCloud
abs_top_builddir = /home/squamous/Projects/banshee-community-extensions
abs_top_srcdir = /home/squamous/Projects/banshee-community-extensions
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build/build.mk $(top_srcdir)/build/build.environment.mk $(top_srcdir)/build/build.rules.mk $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/SoundCloud/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/SoundCloud/Makefile
.PRECIOUS: Makefile
